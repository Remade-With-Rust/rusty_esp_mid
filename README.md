...
[![crates.io](https://img.shields.io/crates/v/rusty_esp_mid.svg)](https://crates.io/crates/rusty_esp_mid)
[![docs.rs](https://docs.rs/rusty_esp_mid/badge.svg)](https://docs.rs/rusty_esp_mid)
...
```text
crates/rusty_esp_mid          facade: re-exports + prelude; the crate you depend on
crates/rusty_esp_mid-core     no_std + alloc; forbid(unsafe); types, traits, algorithms
crates/rusty_esp_mid-esp      the WRAP crate: `esp-hal` (Track B) | `esp-idf` (Track A)
...
cargo check -p rusty_esp_mid-core --no-default-features \
  --target riscv32imac-unknown-none-elf                  # ESP32-C6 class, no alloc
cargo check -p rusty_esp_mid-core --no-default-features --features alloc \
