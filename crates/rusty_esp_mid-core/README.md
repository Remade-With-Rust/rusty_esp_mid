...
[![Remade With Rust](https://img.shields.io/badge/Remade%20With-Rust-000?logo=rust&logoColor=fff)](https://github.com/remade-with-rust) [![By Mata Network](https://img.shields.io/badge/by-Mata%20Network-5b2be0)](https://www.mata.network) [![crates.io](https://img.shields.io/crates/v/rusty_esp_mid-core.svg)](https://crates.io/crates/rusty_esp_mid-core) [![docs.rs](https://docs.rs/rusty_esp_mid-core/badge.svg)](https://docs.rs/rusty_esp_mid-core) [![License: MIT OR Apache-2.0](https://img.shields.io/badge/license-MIT%20OR%20Apache--2.0-blue)](https://github.com/Remade-With-Rust/rusty_esp_mid/blob/main/LICENSE-MIT)

The pure half of the identity package: a P-256 device `did:mata`, the byte-identical signer, signed assertions with a replay window, the self-issued token, capability matching, and the owner adoption grant. `no_std`, `forbid(unsafe)`.

Agreement with the wider MATA stack is a test, not an intention: signatures equal the reference signer for the same key, and the capability check agrees with the reference implementation on **144 of 144 cases**.

## Where the evidence is

This crate is part of [`rusty_esp_mid`](https://crates.io/crates/rusty_esp_mid). The
hardware results, the method lines and the open defects live in that package's
[README](https://github.com/Remade-With-Rust/rusty_esp_mid#readme) and in
[`docs/LEDGER.md`](https://github.com/Remade-With-Rust/rusty_esp_mid/blob/main/docs/LEDGER.md), where no number
